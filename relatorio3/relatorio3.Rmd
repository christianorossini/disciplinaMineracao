...
Todos os kernels testados obtiveram uma certa padronização dos resultados, exceto para a sigmoid. Embora este último seja a função de ativação mais comum dentre os Kernels SVM, se mostrou menos efetivo que as outras funções para o dataset em tela. 