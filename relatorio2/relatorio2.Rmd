...
É perceptível notar que ao realizar um ajuste fino no número de "boostings interations", adicionando novas árvores de decisão para se chegar a melhor acurácia, chega-se a um resultado no qual a quantidade de TPs é 100%, enquanto a quantidade de FPs e FNs é 0. 
Com isso, precision e recall, como também as demais métricas, são alavancados para cima.